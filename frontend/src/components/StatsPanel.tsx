    ...
    <div className="flex flex-col gap-3 p-4 h-full justify-center">
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="text-center">
          ...
          <span className="text-sm text-g-muted">Critical</span>
        </div>
        <div className="text-center">
          <p className="text-2xl font-bold text-g-orange font-mono">{stats.medium}</p>
          <span className="text-sm text-g-muted">Warning</span>
        </div>
      </div>

      <div className="border-t border-g-border pt-2">
        <div className="flex items-center gap-2">
          <span className="text-sm text-g-muted">Audio</span>
          <button
            onClick={toggleAudio}
        ...
        <span className={`text-xs mt-1 block ${audioEnabled ? "text-g-green" : "text-g-muted"}`}>
