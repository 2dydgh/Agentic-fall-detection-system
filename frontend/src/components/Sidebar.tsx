...
export function Sidebar() {
  return (
    <aside className="w-12 shrink-0 bg-g-panel border-r border-g-border flex flex-col items-center py-3 gap-1">
      {/* Logo */}
      <div className="w-7 h-7 rounded bg-g-orange/15 flex items-center justify-center mb-4">
        <span className="text-g-orange text-xs font-bold">D</span>
      </div>
